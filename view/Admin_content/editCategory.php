...
if (isset($_GET['idCategory'])) {
    $categoryData = $categoryCtr->getCategory($_GET['idCategory']);
    if (!$categoryData) {
...
if (isset($_POST['update'])) {
    $c = new Category();
    $c->setIdCategory($_POST['idCategory']);
    $c->setCategoryName($_POST['nameCategory']);
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
        ...
        $c->setImage($categoryData['image']);
    }

    $result = $categoryCtr->modifyCategory($c);
    if ($result) {
        header('Location: ./index.php');
        exit;
    } else {
                  ...
                  >
                    ...
                    <li class="flex">
                      ...
                      >
                        ...
                        <form action="./editCategory.php" method="post" e>
          ...
          <div class="container px-6 mx-auto grid">
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                  ...
                  <form action="./editCategory.php?idCategory=<?= $_GET['idCategory'] ?>" method="post" enctype="multipart/form-data">
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <input type="hidden" name="idCategory" value="<?= $categoryData['idCategory']  ?>" />
